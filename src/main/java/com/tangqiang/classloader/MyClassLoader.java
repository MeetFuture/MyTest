...
public class MyClassLoader extends ClassLoader {
	...
	protected Class<?> findClass(String name) throws ClassNotFoundException {
		...
		try {
			...
			// 将字节流变成一个class
			return defineClass("com.tangqiang.cls.ClassLoaderAttachment", classByte, 0, classByte.length);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void main(String[] args) throws Exception {
		// 配置运行参数
		String srcPath = "D:\\SVNSource\\FEELView6.0\\Trunk\\03-Code\\java\\FEELVision_Test\\bin\\com\\tangqiang\\cls\\ClassLoaderAttachment.class";// ClassLoaderAttachment.class原路径
		String desPath = "D:\\SVNSource\\FEELView6.0\\Trunk\\03-Code\\java\\FEELVision_Test\\tmp";// ClassLoaderAttachment.class输出的路径
